...
return array(
    'Names' => array(
        ...
        'en_GD' => 'ఆంగ్లం (గ్రెనడా)',
        'en_GG' => 'ఆంగ్లం (గర్న్‌సీ)',
        'en_GH' => 'ఆంగ్లం (ఘనా)',
        'en_GI' => 'ఆంగ్లం (జిబ్రాల్టర్)',
        ...
        'en_IO' => 'ఆంగ్లం (బ్రిటీష్ హిందూ మహాసముద్ర ప్రాంతం)',
        'en_JE' => 'ఆంగ్లం (జెర్సీ)',
        'en_JM' => 'ఆంగ్లం (జమైకా)',
        'en_KE' => 'ఆంగ్లం (కెన్యా)',
        'en_KI' => 'ఆంగ్లం (కిరిబాటి)',
        'en_KN' => 'ఆంగ్లం (సెయింట్ కిట్స్ మరియు నెవిస్)',
        'en_KY' => 'ఆంగ్లం (కేమాన్ దీవులు)',
        'en_LC' => 'ఆంగ్లం (సెయింట్ లూసియా)',
        'en_LR' => 'ఆంగ్లం (లైబీరియా)',
        'en_LS' => 'ఆంగ్లం (లెసోతో)',
        'en_MG' => 'ఆంగ్లం (మడగాస్కర్)',
        'en_MH' => 'ఆంగ్లం (మార్షల్ దీవులు)',
        'en_MO' => 'ఆంగ్లం (మకావ్ ఎస్ఏఆర్ చైనా)',
        'en_MP' => 'ఆంగ్లం (ఉత్తర మరియానా దీవులు)',
        'en_MS' => 'ఆంగ్లం (మాంట్సెరాట్)',
        'en_MT' => 'ఆంగ్లం (మాల్టా)',
        ...
        'en_PG' => 'ఆంగ్లం (పాపువా న్యూ గినియా)',
        'en_PH' => 'ఆంగ్లం (ఫిలిప్పైన్స్)',
        'en_PK' => 'ఆంగ్లం (పాకిస్తాన్)',
        'en_PN' => 'ఆంగ్లం (పిట్‌కెయిర్న్ దీవులు)',
        'en_PR' => 'ఆంగ్లం (ప్యూర్టో రికో)',
        'en_PW' => 'ఆంగ్లం (పాలావ్)',
        ...
        'en_TC' => 'ఆంగ్లం (టర్క్స్ & కైకోస్ దీవులు)',
        'en_TK' => 'ఆంగ్లం (టోకెలావ్)',
        'en_TO' => 'ఆంగ్లం (టాంగా)',
        ...
        'en_VC' => 'ఆంగ్లం (సెయింట్ విన్సెంట్ & గ్రెనడీన్స్)',
        ...
        'fr_BL' => 'ఫ్రెంచ్ (సెయింట్ బర్తేలెమీ)',
        'fr_CA' => 'ఫ్రెంచ్ (కెనడా)',
        ...
        'lb' => 'లక్సెంబర్గిష్',
        'lb_LU' => 'లక్సెంబర్గిష్ (లక్సంబర్గ్)',
        'lg' => 'గాండా',
        'lg_UG' => 'గాండా (ఉగాండా)',
        'ln' => 'లింగాల',
        'ln_AO' => 'లింగాల (అంగోలా)',
        ...
        'nb_SJ' => 'నార్వేజియన్ బొక్మాల్ (స్వాల్‌బార్డ్ & జాన్ మాయెన్)',
        'nd' => 'ఉత్తర దెబెలె',
        ...
        'sr_Cyrl_ME' => 'సెర్బియన్ (సిరిలిక్, మోంటెనీగ్రో)',
